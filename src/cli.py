...
def get_args():
    ...
    parser_list = subparsers.add_parser('list', help="Lists tags")
    subparsers_list = parser_list.add_subparsers(title='list subcommand', dest='list_subcommand', required=True)
    parser_list_tags = subparsers_list.add_parser('tags')
    parser_list_tags.add_argument('-p', '--pprint', action='store_true')
    parser_list_repos = subparsers_list.add_parser('repos')
    parser_list_repos.add_argument('-p', '--pprint', action='store_true')
